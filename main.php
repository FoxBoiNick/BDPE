...
<div class="header">
    <div class="icon noselect">
        <img src="/bdpe_data/img/logo.jpg" alt="icon" draggable="false" id="site-logo">
    </div>
    ...
    <div class="app-data" id="app-data">
        <div class="display">
                    ...
                    <div class="banner-shade">
                        ...
                        <div class="profile-info">
                            <div class="user-stars">
                                <h1 class="name" id="userName"></h1><img src="/bdpe_data/img/tourPass.webp" height="24px" width="24px" id="TourPassPin"></img>
                            </div>
                            <div class="user-stars">
                                <img src="/bdpe_data/img/star.webp" height="15px" width="15px"></img><p class="id" id="userStars"></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="tab rounded center-page" tab_id="FullView">
                ...
                <!-- <button class="tablinks" onclick="openView(event, 'BeatScoreLink')">BeatSCORE Link</button> -->
            </div>
                ...
                <div class="card temp1">
                    ...
                    <div class="card-stat">
                        <div class="stat">
                            ...
                            <h3 class="card-stat-text">You've bragged to <span class="stat-color" id="userBrags">---</span> different people</h3>
                        </div>
                    ...
                    <div class="card-stat">
                        <div class="stat">
                            ...
                            <h3 class="card-stat-text">You have <span class="stat-color" id="recievedBrags">---</span> active brags</h3>
                        </div>
            ...
            <div class="tabcontent full griddata" id="BeatScoreLink" for="FullView" display-type="grid">
                <?php if($User != null) { ?>
                <h2>Import your song stats into BeatSCORE</h2>
                <p>You can import your scores (Song medals) to BeatSCORE's personal collection to keep track of your game progress!</p>
                <button class="beatscore-link-import">Import</button>
                <p>Pressing this button will take the song reference and achieved medal and update your BeatSCORE personal collection. No other data is sent to the server.</p>
                <?php } else { ?>
                    <h2>Import your song stats into BeatSCORE</h2>
                    <p>Keep track of your song progress on BeatSCORE! With a BeatSCORE account you can import all of your song data to your BeatSCORE personal collection.</p>
                    <button class="beatscore-link-login">Login/Register</button>
                <?php } ?>

                <img src="/images/collection-demo.jpg" />
            </div>
        </div>
    </div>
    <div class="app-container" id="app-input">
